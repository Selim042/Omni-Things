...
public class GoggleCrafting implements IRecipe {
	...
	public ItemStack getCraftingResult(InventoryCrafting craftingTable) {
		...
		ItemStack result = new ItemStack(OmniStuff.omniGoggles);
		if (stack4Item.equals(OmniStuff.omniGoggles)) {
	...
	public ItemStack getRecipeOutput() {
		return new ItemStack(OmniStuff.omniGoggles);
	}
}
