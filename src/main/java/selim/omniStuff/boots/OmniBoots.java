...
public class OmniBoots extends ItemArmor implements IEnergyContainerItem {

	String[] neiLore = {"One pair of boots with", "different possible modules."};
	String[] craftingHelp = {"Put boots in middle", "slot of crafting table,",
							"then put any compatible", "module anywhere else."};
	
	String[] moduleID = {"potionsModule", "fallModule"};
	...
	//potions, step assist, fall resist
	public OmniBoots() {
		super(OmniStuff.omniArmorMaterial, 0, 3);
		setUnlocalizedName("omniBoots");
		setCreativeTab(CreativeTabs.tabCombat);
		setCreativeTab(OmniStuff.omniStuffTab);
		setTextureName(ModInfo.ID + ":" + "boots/basic");
	}
