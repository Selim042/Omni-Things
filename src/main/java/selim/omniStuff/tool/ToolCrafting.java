...
public class ToolCrafting implements IRecipe {
	...
	public boolean matches(InventoryCrafting p_77569_1_, World p_77569_2_) {
		ItemStack referenceStack = new ItemStack(OmniStuff.omniTool);
		boolean valid = false;
	...
	public ItemStack getCraftingResult(InventoryCrafting craftingTable) {
		Item[] upgrades = {OmniStuff.potionsModule,
							OmniStuff.paxelModule,
							OmniStuff.wrenchModule,
							OmniStuff.vanillaUtilsModule};
		String[] upgradeID = {"potionsModule", "paxelModule", "wrenchModule", "vanillaUtilsModule"};
		
		boolean valid = true;
		ItemStack stack4 = craftingTable.getStackInSlot(4);
		Item stack4Item = stack4.getItem();
		ItemStack result = new ItemStack(OmniStuff.omniTool);
		if (stack4Item.equals(OmniStuff.omniTool)) {
	...
	public ItemStack getRecipeOutput() {
		return new ItemStack(OmniStuff.omniTool);
	}
}
